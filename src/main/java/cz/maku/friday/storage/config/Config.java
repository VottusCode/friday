...
public class Config {
    ...
    public void createNewFile() {
        try {
            file.createNewFile();
            logger.log(Logger.LoggerType.SUCCESS, "File " + fileName + " was created at " + plugin.getDataFolder() + ".", true);
        } catch (IOException exception) {
            exception.printStackTrace();
            logger.log(Logger.LoggerType.ERROR, "There is an error while creating file " + fileName + " in folder " + plugin.getDataFolder() + ".", true);
        }
    }
    ...
    public void save() {
        try {
            ...
            exception.printStackTrace();
            logger.log(Logger.LoggerType.ERROR, "There is an error while saving file " + fileName + " in folder " + plugin.getDataFolder() + ".", true);
        }
    }
    ...
    public void reload() {
        ...
        if (defaultStream != null) {
            YamlConfiguration defauultConfig = YamlConfiguration.loadConfiguration(new InputStreamReader(defaultStream));
