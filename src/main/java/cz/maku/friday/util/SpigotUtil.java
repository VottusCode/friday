...
public class SpigotUtil {
    ...
    public static double[] getTPS() {
        ...
        try {
            ...
            Object serverObject = serverClass.getDeclaredMethod("getServer").invoke(serverClass);
            Field field = serverClass.getDeclaredField("recentTps");
            Object tpsObj = field.get(serverObject);
            double[] result = (double[]) tpsObj;
            return result;
        } catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException | NoSuchFieldException | ClassNotFoundException var6) {
